...
public class TestMail extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            session = (Session) initContext.lookup("java:jboss/mail/lorintech");
            Address from = new InternetAddress("comessage@lorintech.com");
            Address to = new InternetAddress("lorin@public-action.org");
            Message message = new MimeMessage(session);
            message.setFrom(from);
            message.setRecipient(Message.RecipientType.TO, to);
            message.setSubject("test email connect");
